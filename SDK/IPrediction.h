...
public:
	bool InPrediction()
	{
		...
		return U::GetVFunc<oInPrediction>( this, 14 )( this );
	}
	...
	void RunCommand( C_BasePlayer *player, CUserCmd *ucmd, IMoveHelper *moveHelper )
	{
		...
		return U::GetVFunc<oRunCommand>( this, 19 )( this, player, ucmd, moveHelper );
	}
	...
	void SetupMove( C_BasePlayer *player, CUserCmd *ucmd, IMoveHelper *moveHelper, void* pMoveData )
	{
		...
		return U::GetVFunc<oSetupMove>( this, 20 )( this, player, ucmd, moveHelper, pMoveData );
	}
	...
	void FinishMove( C_BasePlayer *player, CUserCmd *ucmd, void*pMoveData )
	{
		...
		return U::GetVFunc<oFinishMove>( this, 21 )( this, player, ucmd, pMoveData );
	}
};